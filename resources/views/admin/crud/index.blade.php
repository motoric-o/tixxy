...
@section('content')
    ...
    <div class="flex items-center justify-end w-full gap-3">
        @if (isset($compareUrl))
            <a href="{{ $compareUrl }}"
                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 transition-all duration-300 shadow-sm whitespace-nowrap">
        ...
        @if ($createUrl)
            <a href="{{ $createUrl }}"
                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white rounded-lg bg-gradient-to-r from-[#4a00e0] via-[#8e2de2] to-[#4a00e0] bg-[length:200%_auto] hover:bg-[position:right_center] transition-all duration-300 shadow-md hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] whitespace-nowrap">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        <div
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    <thead
                        class="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 bg-gray-50/50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                        <tr>
                            @foreach ($columns as $col)
                                <th class="px-6 py-4">
                                    @if (isset($col['sortable']) && $col['sortable'] === false)
                                    ...
                                    @else
                                        ...
                                        <a href="{{ $sortUrl }}"
                                            ...
                                            <span
                                                class="{{ $isSorted ? 'text-purple-600 dark:text-purple-400 font-bold' : '' }}">
                                                {{ $col['label'] }}
                                            </span>
                                            <div class="flex flex-col gap-0.5">
                                                @if ($isSorted)
                                                    ...
                                                    @endif
                                                @else
                                                    <svg class="w-3 h-3 opacity-0 group-hover:opacity-100 text-gray-400 transition-opacity"
                                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="{{ count($columns) + 1 }}"
                                    ...
                                    <div class="flex flex-col items-center">
                                        <svg class="w-16 h-16 opacity-20 mb-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                                d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4">
                                            </path>
                                        </svg>
                                        <p class="text-xl font-bold tracking-tight">No {{ strtolower($title) }} records
                                            found</p>
