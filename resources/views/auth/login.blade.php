<x-layouts.guest>
    ...
    <form action="{{ route('login') ?? '#' }}" method="POST" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('password.request') ?? 'forgot-password.html' }}" class="text-sm text-blue-600 hover:underline">Forgot Password?</a>
        </div>
        <div>
            <button
                type="submit"
    ...
    <div class="text-sm text-gray-600 dark:text-gray-400">
        Don't have an account yet? <a href="{{ route('register') ?? 'register.html' }}" class="text-blue-600 hover:underline">Register</a>
    </div>
</x-layouts.guest>
