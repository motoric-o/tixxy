<div class="flex flex-col py-4 px-[14px] sticky top-5 h-[calc(100vh-40px)] bg-gray-200 dark:bg-gray-800 rounded-xl transition-all duration-300 overflow-y-auto overflow-x-hidden shrink-0" :class="sidebarOpen ? 'w-1/6' : 'w-[88px]'">
    ...
    <div class="flex flex-col px-[8px] py-1 transition-all duration-300">
        {{-- 1. Dashboard --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/dashboard*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/dashboard" title="Dashboard">
        ...
        {{-- 2. Financial --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/financial*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/financial" title="Financial">
        ...
        {{-- 3. Events --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/events*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/events" title="Events">
        ...
        {{-- 4. Orders --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/orders*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/orders" title="Orders">
            <svg class="w-7 h-7 drop-shadow-[0_0_5px_rgba(233,213,255,0.8)] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">Orders</span>
        </a>
        
        {{-- 5. Tickets --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/tickets*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/tickets" title="Tickets">
            <svg class="w-7 h-7 drop-shadow-[0_0_5px_rgba(233,213,255,0.8)] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg>
            <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">Tickets</span>
        </a>
        
        {{-- 6. Scan --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/scanner*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/scanner" title="Scan">
        ...
        {{-- 7. Management --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/users*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/users" title="Users">
        ...
        {{-- 8. Configuration --}}
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/ticket-types*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/ticket-types" title="Ticket Types">
        ...
        <a class="p-2 text-[#e9d5ff] hover:text-white rounded-lg bg-[#4a00e0] transition-colors duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] focus:outline-none border border-transparent hover:border-white/20 my-2 flex items-center gap-3 overflow-hidden {{ request()->is('manage/categories*') ? 'shadow-[0_0_15px_rgba(168,85,247,0.4)] border-white/20 bg-[#5910db]' : '' }}" href="/manage/categories" title="Categories">
