            ...
            <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
                ...
                <div class="space-y-2">
                    <h1 id="pageTitle" class="flex items-center space-x-2">
                        ...
                        <span class="text-xl font-medium text-gray-600 sm:text-2xl dark:text-light">Oops! Something went wrong.</span>
                    </h1>
                    <p class="text-base font-normal text-gray-600 dark:text-gray-300">The page you are looking for is temporarily unavailable.</p>
