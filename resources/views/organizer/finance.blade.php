...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
        <div class="mb-4">
            ...
            <p class="text-xs text-gray-400 mt-0.5">Distribution across your event categories</p>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center justify-between py-2 px-3 rounded-xl bg-gray-50 dark:bg-gray-700">
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Your top events by revenue</p>
            </div>
        </div>
        @if($topEvents->count() > 0)
        <div class="space-y-2 max-h-[420px] overflow-y-auto pr-1">
            @foreach ($topEvents as $index => $event)
            <div class="flex items-center gap-3 py-3 px-3 rounded-xl bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                {{-- Rank --}}
