              ...
              <div class="flex-1 p-4 space-y-8 overflow-y-hidden hover:overflow-y-auto">
                ...
                <div class="flex flex-col items-center space-y-2">
                  ...
                  <img
                    ...
                    src="{{ asset('dash_assets/') }}/images/avatar.jpg"
                    alt="Ahmed Kamel"
                  />
                  ...
                  <div class="space-y-4">
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        ...
                        src="{{ asset('dash_assets/') }}/images/avatar-1.jpg"
                        alt="John Doe"
                      />
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="{{ asset('dash_assets/') }}/images/cover.jpg"
                        alt="John Doe"
                      />
                      <div class="overflow-hidden">
                        <h4
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="{{ asset('dash_assets/') }}/images/cover-3.jpg"
                        alt="John Doe"
                      />
                      <div class="overflow-hidden">
                        <h4
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="{{ asset('dash_assets/') }}/images/cover-2.jpg"
                        alt="John Doe"
                      />
                      <div class="overflow-hidden">
                        <h4
